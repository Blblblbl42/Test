...
class MainWindow(QMainWindow):
    ...
    def get_input_data(self):
        ...
        quantité_1 = self.lineEdit_10.text()
        quantité_2 = self.lineEdit_11.text()
        quantité_3 = self.lineEdit_12.text()
        quantité_4 = self.lineEdit_13.text()
        quantité_5 = self.lineEdit_14.text()
        quantité_6 = self.lineEdit_15.text()
        quantité_7 = self.lineEdit_16.text()
        quantité_8 = self.lineEdit_17.text()
